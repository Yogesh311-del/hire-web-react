...
const Header =(props) => {
    return (
        <Container>
            ...
            <Logo>
                <a href='/home'>
                    <img src='https://i.ibb.co/VpdRxvg/home-logo.png' alt='' />
                </a>
            </Logo>
            <Search>
                <div>
            ...
            <NavListWrap>
                ...
                <NavList>
                    <a href="https://www.linkedin.com/messaging/thread/2-YWI5NmJlZDYtYmRkMi00ZTJkLWIyNWMtYzY1MGYyNWYxNTBkXzAxMw==/" target='_blamk'>
